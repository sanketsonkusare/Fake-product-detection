...
import { contractABI, contractAddress, url } from '../lib';
                ...
                <div class="font-sans p-4 text-black w-full  justify-center">
                    ...
                    <div class="w-full px-4 py-4 mx-auto">
                        <form onSubmit={handleSubmit}>
                            ...
                            {productCreated && <div>
                                <p className='text-normal my-2 text-green-500 font-bold'>Product with ID {productCreated} created Successfully!</p>
                                <QRCode value={`${url}/checkproduct?id=${productCreated}`} />
                            </div>}
                            <div>
                            </div>
                        </form>
